...
frappe.query_reports["Route Wise Attendance"] = {
	filters: [
		...
		},
		{
			...
			label: __("Group By"),
			fieldtype: "Select",
			options: ["", "Branch", "Grade", "Department", "Designation", "Route", "Area", "Zone"],
			default: "Route",
		},
		{
	...
	onchange: function(report) {
		...
		// Auto-set and disable summarized view for Route/Area/Zone
		if (['Route', 'Area', 'Zone'].includes(group_by)) {
